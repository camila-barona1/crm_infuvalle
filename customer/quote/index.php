...
<div class="card-header">
    <h5 class="card-title">Solicitud de cotización</h5>
</div>
<style>
.callout td{
...
<div class="card-body">
    <form action="" id="request-form">
        <div class="form-group">
            <label for="email" class="control-label">Enviar cotización a:</label>
...
<button class="btn btn-primary btn-flat" form="request-form">Enviar solicitud</button>
</div>
</div>
