...
if($_settings->userdata('id') > 0){
	$user = $conn->query("SELECT * FROM customers where id ='".$_settings->userdata('id')."'");
	// echo "<pre>";
	// print_r($user);
	// echo "</pre>";
		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					...
					<input type="text" name="username" id="username" class="form-control" readonly value="<?php echo isset($meta['username']) ? $meta['username']: $_settings->userdata('username') ?>" required  autocomplete="off">
				</div>
				<div class="form-group">
...
<script>
	...
	$('#manage-user').submit(function(e){
		...
		start_loader()
		$.ajax({
			url:_base_url_+'classes/Users.php?f=save_customer',
