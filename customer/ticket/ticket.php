...
<div class="callout">
	...
	<tr>
		...
		<th style="text-align: center">
			...
			<hr>
			<span>&nbsp&nbspEstado: <span class="badge <?php echo $status_badge ?>"><?php echo $status ?></span></span>
			<span class="float-left"><span><i>Fecha de creación</i>:</span> <span class="badge badge-light ticket-created"><?php echo date("Y-m-d h:i A",strtotime($date_created)) ?></span></span>
		</th>
	</tr>
	</table>
</div>
			...
			<table class="table">
				...
				<tr>
					...
					<td>
						...
						<span class="badge badge-pill badge-info"><span class="comment-date"></span></span>
						<hr class="border-primary">
				...
				if(!!resp.status){
					if(resp.data.length > 0){
						...
						let item = $("#comment_clone").clone();
							...
							item.find('.comment-date').html(data[k].date_created);
							if(!!data[k].id)
