			...
			<div class="card-body">
				<div class="container-fluid">
						...
						<div class="input-group">
	                        <input type="search" id="keyword" class="form-control form-control-sm" value="<?php echo isset($_GET['keyword']) ? $_GET['keyword'] : '' ?>" placeholder="Escriba sus palabras clave aquí">
...
<script>
	...
	$(document).ready(function(){
		...
		$('#new_data').click(function(){
			uni_modal('<span class="fa fa-plus"></span> Create New Service Category',_base_url_+'customer/services/manage_category.php')
		})
